    ...
    >
      <div className="md:pb-0 lg:pb-0 relative z-10">
        <div className="flex flex-col justify-center items-center  md:mt-30 mt-0 md:mb-50 mb-20">
          <img
            src="/assets/vectorn.png"
            alt="element3"
            className="h-8 md:mb-5 mb-3"
          />
        ...
        <div className="flex justify-center items-center md:gap-10 gap-4 md:px-0 px-5">
          <div className="relative flex justify-center">
            <img
              src="/assets/ronak_img.png"
              alt="element3"
              className="md:h-150 h-55"
            />
...
<div className="z-100 flex flex-col items-center">
          ...
          <h2 className="text-[#4D4635] md:text-[16px] text-[15px] text-center font-playfair-display mt-3 md:px-0 px-10">
            150 Feet Ring Rd, Near Westwood School, Ronki, Rajkot, Gujarat
            360028
          </h2>
