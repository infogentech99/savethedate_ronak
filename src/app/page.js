      ...
      >
        ...
        <div className="md:pb-50 lg:pb-30 relative z-10 pb-24 ">
          <div className="flex flex-col justify-center items-center  md:mt-50 mt-20 md:mb-50 mb-20">
            ...
            <h2 className="text-[#BF9772] md:text-[18px] text-[14px] text-center font-manrope mt-6 px-10 md:px-0">
          ...
          <div className="flex flex-col justify-center items-center mt-18">
            <img
              ...
              className="w-35"
            />
            <h2 className="text-[#BF9772] md:text-xl text-[16px] text-center font-playfair-display md:mt-12 mt-8">
